...
describe('ngx-polar-chart-group', () => {
  ...
  it('should create single group by date', () => {
  ...
  it('should create two groups by date', () => {
  ...
  it('should create single group by series', () => {
  ...
  it('should create two groups by series', () => {
