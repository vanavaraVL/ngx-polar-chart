...
export class Builder implements IBuilder {
  ...
  private overridePlotSettings(plotSettings: NgxPolarChartSettings): void {
    ...
    if (!plotSettings.barsSettings.weekend) {
      plotSettings.barsSettings.weekend = {};
    }

    plotSettings.barsSettings.weekend.color ??= this.defaultPlotSettings.barsSettings!.weekend!.color;
    plotSettings.barsSettings.weekend.showColorBar ??= this.defaultPlotSettings.barsSettings!.weekend!.showColorBar;
